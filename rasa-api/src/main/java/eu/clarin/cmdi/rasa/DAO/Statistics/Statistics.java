...
public class Statistics {
	...
	/*
	 * public Statistics(Record record) { //these values are named in the query in
	 * ACDHStatisticsResource this.count = (Long) record.getValue("count");
	 * this.avgRespTime = ((BigDecimal)
	 * record.getValue("avgDuration")).doubleValue(); Object maxDR =
	 * record.getValue("maxDuration"); if (maxDR instanceof Integer) {
	 * this.maxRespTime = (Integer) maxDR; } else if (maxDR instanceof Long) {
