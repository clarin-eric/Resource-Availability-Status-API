...
INSERT INTO status(url,method,statusCode,contentType,byteSize,duration,timestamp,redirectCount,record,collection,expectedMimeType)
VALUES
("http://www.ailla.org/waiting.html", "HEAD", 200, "text/html; charset=UTF-8", 100, 132, @then, 0,"record", "NotGoogle", null),
("http://www.ailla.org/audio_files/EMP1M1B1.mp3", "GET",  400, "text/html; charset=UTF-8", 0, 46, @then, 0, "record", "NotGoogle", null),
("http://www.ailla.org/audio_files/WBA1M3A2.mp3", "GET",  400, "text/html; charset=UTF-8", 0, 46, @then, 0, "record", "NotGoogle", null),
("http://www.ailla.org/text_files/WBA1M1A2a.mp3", "GET",  400, "text/html; charset=UTF-8", 0, 46, @then, 0, "record", "NotGoogle", null),
("http://www.ailla.org/audio_files/KUA2M1A1.mp3", "GET",  400, "text/html; charset=UTF-8", 0, 56, @then, 0, "record", "NotGoogle", null),
("http://www.ailla.org/text_files/KUA2M1.pdf", "HEAD",  200, "text/html; charset=UTF-8", 0, 51, @then, 0, "record", "NotGoogle", null),
("http://www.ailla.org/audio_files/sarixojani.mp3", "GET",  400, "text/html; charset=UTF-8", 0, 48, @then, 0, "record", "NotGoogle", null),
("http://www.ailla.org/audio_files/TEH11M7A1sa.mp3", "GET",  400, "text/html; charset=UTF-8", 0, 48, @then, 0, "record", "NotGoogle", null),
("http://www.ailla.org/text_files/TEH11M7.pdf", "HEAD",  200, "text/html; charset=UTF-8", 0, 57, @then, 0, "record", "NotGoogle", null),
("http://dspin.dwds.de:8088/ddc-sru/dta/", "HEAD",  200, "application/xml;charset=utf-8", 2094, 67, @then, 0, "record", "NotGoogle", null),
("http://dspin.dwds.de:8088/ddc-sru/grenzboten/", "HEAD",  200, "application/xml;charset=utf-8", 2273, 57, @then, 0, "record", "NotGoogle", null),
("http://dspin.dwds.de:8088/ddc-sru/rem/", "HEAD",  200, "application/xml;charset=utf-8", 2497, 58, @then, 0, "record", "NotGoogle", null),
("http://www.deutschestextarchiv.de/rem/?d=M084E-N1.xml", "HEAD",  200, "text/html; charset=utf-8", 0, 591, @then, 0, "record", "NotGoogle", null),
("http://www.deutschestextarchiv.de/rem/?d=M220P-N1.xml", "HEAD",  200, "text/html; charset=utf-8", 0, 592, @then, 0, "record", "NotGoogle", null),
("http://www.deutschestextarchiv.de/rem/?d=M119-N1.xml", "HEAD",  200, "text/html; charset=utf-8", 0, 602, @then, 0, "record", "NotGoogle", null),
("http://www.deutschestextarchiv.de/rem/?d=M171-G1.xml", "HEAD",  200, "text/html; charset=utf-8", 0, 613, @then, 0, "record", "NotGoogle", null),
("http://www.deutschestextarchiv.de/rem/?d=M185-N1.xml", "HEAD",  200, "text/html; charset=utf-8", 0, 605, @then, 0, "record", "NotGoogle", null),
("http://www.deutschestextarchiv.de/rem/?d=M048P-N1.xml", "HEAD",  200, "text/html; charset=utf-8", 0, 599, @then, 0, "record", "NotGoogle", null),
("http://www.deutschestextarchiv.de/rem/?d=M112-G1.xml", "HEAD",  200, "text/html; charset=utf-8", 0, 591, @then, 0, "record", "NotGoogle", null),
("https://www.google.com", "HEAD",  200, "text/html; charset=ISO-8859-1", 0, 222, @then, 0, "GoogleRecord", "Google", null),
("https://maps.google.com", "HEAD",  200, "text/html; charset=UTF-8", 0, 440, @then, 2, "GoogleRecord", "Google", null),
("https://drive.google.com", "HEAD",  200, "text/html; charset=UTF-8", 73232, 413, @then, 1, "GoogleRecord", "Google", null);