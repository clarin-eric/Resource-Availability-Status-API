...
public class ACDHLinkToBeCheckedFilter implements LinkToBeCheckedFilter {
     ...
     */
    public ACDHLinkToBeCheckedFilter(Long harvestDate) {
    ...
    public PreparedStatement getStatement(Connection con) throws SQLException {
        //if it comes here, then it means there is a collection or harvestDate to be filtered
        ...
        if (collection != null) {
            ...
            statement.setLong(1, harvestDate);
        }
        return statement;
